...
export const DashboardUserButton = () => {
    ...
    return (
        <DropdownMenu>
            ...
            itens-centre justify-between bg-white/5 hover:bg-white/10 overflow-hidden'>
                {data.user.image ? (
                    <Avatar>
            ...
            <DropdownMenuContent align='end' side='right' className='w-72'>
                ...
                <DropdownMenuItem onClick={onLogout} className='cursor-pointer flex item-center justify between'>
                    Logout
